/* src/GLOW/nrlmsise00.f -- translated by f2c (version 20160102).
...
struct parm7_2_
{
    real pt1[50], pt2[50], pt3[50], pa1[50], pa2[50], pa3[50], pb1[50], pb2[50], pb3[50], pc1[50], pc2[50], pc3[50], pd1[50], pd2[50], pd3[50], pe1[50], pe2[50], pe3[50], pf1[50], pf2[50], pf3[50], pg1[50],
...
#define datim7_1 (datim7_._1)
#define datim7_2 (datim7_._2)
...
static real c_b37 = 1e3f;
static real c_b45 = 28.f;
static real c_b54 = 4.f;
static real c_b58 = 16.f;
static real c_b62 = 32.f;
static real c_b67 = 40.f;
static real c_b75 = 14.f;
static doublereal c_b96 = .5;
static real c_b105 = 2.f;
static integer c__9 = 9;
static integer c__4 = 4;

/* ----------------------------------------------------------------------- */
/* Subroutine */ int gtd7_(integer *iyd, real *sec, real *alt, real *glat,
                           real *glong, real *stl, real *f107a, real *f107, real *ap, integer *mass, real *d__, real *t)
{
    /* Initialized data */
    ...
    static integer mss;
    extern /* Subroutine */ int gts7_(integer *, real *, real *, real *, real *, real *, real *, real *, real *, integer *, real *, real *);
    static real dm28m, altt, xlat;
    extern doublereal vtst7_(integer *, real *, real *, real *, real *, real *, real *, real *, integer *);
    extern /* Subroutine */ int glatf_(real *, real *, real *);
    extern doublereal densm_(real *, real *, real *, real *, integer *, real *, real *, real *, integer *, real *, real *, real *), glob7s_(
                                                                                                                                        real *);
    ...
    /*        exosphere */
    /*                   -- Quick Fixes for gfortran compatibility, SCS, 2017 */
    /*        NEW FEATURES: */
    ...
    /* Function Body */
    /*     write(6,*) 'inside gtd7' */
    /*     write(6,*) IYD,SEC,ALT,GLAT,GLONG,STL,F107A,F107,AP,MASS,D,T */
    /*     write(6,*) f107a,f107 */
    if (csw_1.isw != 64999)
    {
        tselec_(sv);
    ...
    if (v1 == 1.f || alast >= zn2[0])
    {
        ...
        meso7_1.tn2[1] = parm7_1.pma[0] * mavg7_1.pavgm[0] / (1.f - csw_1.sw[19] * glob7s_(parm7_1.pma));
        meso7_1.tn2[2] = parm7_1.pma[100] * mavg7_1.pavgm[1] / (1.f - csw_1.sw[19] * glob7s_(&parm7_1.pma[100]));
        meso7_1.tn2[3] = parm7_1.pma[200] * mavg7_1.pavgm[2] / (1.f - csw_1.sw[19] * csw_1.sw[21] * glob7s_(&parm7_1.pma[200]));
        /* Computing 2nd power */
        r__1 = parm7_1.pma[200] * mavg7_1.pavgm[2];
        meso7_1.tgn2[1] = mavg7_1.pavgm[8] * parm7_1.pma[900] * (csw_1.sw[19] * csw_1.sw[21] * glob7s_(&parm7_1.pma[900]) + 1.f) *
    ...
    if (v1 == 1.f || alast >= zn3[0])
    {
        ...
        meso7_1.tn3[1] = parm7_1.pma[300] * mavg7_1.pavgm[3] / (1.f - csw_1.sw[21] * glob7s_(&parm7_1.pma[300]));
        meso7_1.tn3[2] = parm7_1.pma[400] * mavg7_1.pavgm[4] / (1.f - csw_1.sw[21] * glob7s_(&parm7_1.pma[400]));
        meso7_1.tn3[3] = parm7_1.pma[500] * mavg7_1.pavgm[5] / (1.f - csw_1.sw[21] * glob7s_(&parm7_1.pma[500]));
        meso7_1.tn3[4] = parm7_1.pma[600] * mavg7_1.pavgm[6] / (1.f - csw_1.sw[21] * glob7s_(&parm7_1.pma[600]));
        /* Computing 2nd power */
        r__1 = parm7_1.pma[600] * mavg7_1.pavgm[6];
        meso7_1.tgn3[1] = parm7_1.pma[700] * mavg7_1.pavgm[7] * (csw_1.sw[21] * glob7s_(&parm7_1.pma[700]) + 1.f) * meso7_1.tn3[4] *
...
L6:
    ...
    /*      ***** N2 DENSITY **** */
    dmr = ds[2] / dm28m - 1.f;
    d__[3] = densm_(alt, &dm28m, &xmm, &tz, &mn3, zn3, meso7_1.tn3,
...
L240:
    ...
    if (*mass == 48)
    {
        d__[6] = (d__[1] * 4.f + d__[2] * 16.f + d__[3] * 28.f + d__[4] * 32.f + d__[5] * 40.f + d__[7] + d__[8] * 14.f) * 1.66e-24f;
        if (metsel_1.imr == 1)
        {
            d__[6] /= 1e3f;
        }
...
L10:
    goto L90;
L50:
    gts3c_1.dd = densm_(alt, &c_b14, &c_b15, &tz, &mn3, zn3, meso7_1.tn3,
                        meso7_1.tgn3, &mn2, zn2, meso7_1.tn2, meso7_1.tgn2);
    /* 0. SCS */
    t[2] = tz;
L90:
...
/* Subroutine */ int gtd7d_(integer *iyd, real *sec, real *alt, real *glat,
                            real *glong, real *stl, real *f107a, real *f107, real *ap, integer *mass, real *d__, real *t)
{
    extern /* Subroutine */ int gtd7_(integer *, real *, real *, real *, real *, real *, real *, real *, real *, integer *, real *, real *);
    ...
    if (*mass == 48)
    {
        d__[6] = (d__[1] * 4.f + d__[2] * 16.f + d__[3] * 28.f + d__[4] * 32.f + d__[5] * 40.f + d__[7] + d__[8] * 14.f + d__[9] * 16.f) * 1.66e-24f;
        if (metsel_1.imr == 1)
        {
            d__[6] /= 1e3f;
        }
...
L10:
    ++l;
    gtd7_(iyd, sec, &z__, glat, glong, stl, f107a, f107, &ap[1], &c__48, &d__[1], &t[1]);
                           ...
                           real *glong, real *stl, real *f107a, real *f107, real *ap, integer *mass, real *d__, real *t)
{
    ...
    static real zhm01, tinf, zhm04, zhm32, zhm16, zhm40, zhm14, zhm28, zmho,
        zsho, hcc232, zsht;
    extern doublereal ccor2_(real *, real *, real *, real *, real *), vtst7_(integer *, real *, real *, real *, real *, real *, real *, real *, integer *), scalh_(real *, real *, real *), densu_(real *, real *, real *, real *, real *, real *, real *, real *, real *, integer *, real *, real *, real *), globe7_(real *, real *, real *, real *, real *, real *, real *, real *, real *), glob7s_(real *);
    ...
    if (*alt > zn1[0])
    {
        ...
        {
            tinf = lower7_1.ptm[0] * parm7_1.pt[0] * (csw_1.sw[15] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], parm7_1.pt) + 1.f);
        }
    }
    else
    {
    ...
    if (*alt > zn1[4])
    {
        ...
        {
            gts3c_1.g0 = lower7_1.ptm[3] * parm7_1.ps[0] * (csw_1.sw[18] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], parm7_1.ps) + 1.f);
        }
    }
    else
    {
    ...
    if (v2 == 1.f || *alt < 300.f)
    {
        gts3c_1.tlb = lower7_1.ptm[1] * (csw_1.sw[16] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[450]) + 1.f) * parm7_1.pd[450];
    }
    ...
    if (*alt < 300.f)
    {
        ...
        {
            meso7_1.tn1[1] = lower7_1.ptm[6] * parm7_1.ptl[0] / (1.f - csw_1.sw[17] * glob7s_(parm7_1.ptl));
            meso7_1.tn1[2] = lower7_1.ptm[2] * parm7_1.ptl[100] / (1.f - csw_1.sw[17] * glob7s_(&parm7_1.ptl[100]));
            meso7_1.tn1[3] = lower7_1.ptm[7] * parm7_1.ptl[200] / (1.f - csw_1.sw[17] * glob7s_(&parm7_1.ptl[200]));
            meso7_1.tn1[4] = lower7_1.ptm[4] * parm7_1.ptl[300] / (1.f - csw_1.sw[17] * csw_1.sw[19] * glob7s_(&parm7_1.ptl[300]));
            /* Computing 2nd power */
            r__1 = lower7_1.ptm[4] * parm7_1.ptl[300];
            meso7_1.tgn1[1] = lower7_1.ptm[8] * parm7_1.pma[800] * (csw_1.sw[17] * csw_1.sw[19] * glob7s_(&parm7_1.pma[800]) + 1.f) *
    ...
    else
    {
        ...
        /* Computing 2nd power */
        r__1 = lower7_1.ptm[4] * parm7_1.ptl[300];
        meso7_1.tgn1[1] = lower7_1.ptm[8] * parm7_1.pma[800] * meso7_1.tn1[4] * meso7_1.tn1[4] / (r__1 * r__1);
    }
    ...
    g28 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[300]);
    day = r_mod(&yrd, &c_b37);
    /*        VARIATION OF TURBOPAUSE HEIGHT */
    zhf = parm7_1.pdl[49] * (csw_1.sw[4] * parm7_1.pdl[24] * sin(dgtr * *glat) * cos(dr * (day - parm7_1.pt[13])) + 1.f);
    yrd = (real)(*iyd);
    t[1] = tinf;
    xmm = lower7_1.pdm[24];
    z__ = *alt;
...
L15:
    ...
    d__[3] = densu_(&z__, &gts3c_1.db28, &tinf, &gts3c_1.tlb, &c_b45, &alpha[2], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[3];
    /*      Turbopause */
    ...
    r__1 = alpha[2] - 1.f;
    b28 = densu_(&zh28, &gts3c_1.db28, &tinf, &gts3c_1.tlb, &xmd, &r__1, &tz,
    ...
    dmix_1.dm28 = densu_(&z__, &b28, &tinf, &gts3c_1.tlb, &xmm, &alpha[2], &tz, &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    /*      Net density at Alt */
    d__[3] = dnet_(&d__[3], &dmix_1.dm28, &zhm28, &xmm, &c_b45);
L17:
    switch (j)
    {
    case 1:
...
L20:
    ...
    g4 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], parm7_1.pd);
    /*      Diffusive density at Zlb */
    gts3c_1.db04 = lower7_1.pdm[0] * exp(g4) * parm7_1.pd[0];
    /*      Diffusive density at Alt */
    d__[1] = densu_(&z__, &gts3c_1.db04, &tinf, &gts3c_1.tlb, &c_b54, alpha, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[1];
    ...
    r__1 = 4.f - xmm;
    r__2 = alpha[0] - 1.f;
    b04 = densu_(&zh04, &gts3c_1.db04, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm04 = densu_(&z__, &b04, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm04 = zhm28;
    /*      Net density at Alt */
    d__[1] = dnet_(&d__[1], &dmix_1.dm04, &zhm04, &xmm, &c_b54);
    /*      Correction to specified mixing ratio at ground */
    gts3c_1.rl = log(b28 * lower7_1.pdm[1] / b04);
    zc04 = lower7_1.pdm[4] * parm7_1.pdl[25];
    hc04 = lower7_1.pdm[5] * parm7_1.pdl[26];
    /*      Net density corrected at Alt */
    d__[1] *= ccor_(&z__, &gts3c_1.rl, &hc04, &zc04);
L24:
    if (*mass != 48)
    {
        goto L90;
...
L25:
    ...
    /*       Density variation factor at Zlb */
    g16 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[150]);
    /*      Diffusive density at Zlb */
    gts3c_1.db16 = lower7_1.pdm[10] * exp(g16) * parm7_1.pd[150];
    /*       Diffusive density at Alt */
    d__[2] = densu_(&z__, &gts3c_1.db16, &tinf, &gts3c_1.tlb, &c_b58, &alpha[1], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[2];
    ...
    r__1 = 16 - xmm;
    r__2 = alpha[1] - 1.f;
    b16 = densu_(&zh16, &gts3c_1.db16, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm16 = densu_(&z__, &b16, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm16 = zhm28;
    /*      Net density at Alt */
    d__[2] = dnet_(&d__[2], &dmix_1.dm16, &zhm16, &xmm, &c_b58);
    ...
    gts3c_1.rl = lower7_1.pdm[11] * parm7_1.pdl[41] * (csw_1.sw[0] * parm7_1.pdl[23] * (*f107a - 150.f) + 1.f);
    ...
    /*      Net density corrected at Alt */
    d__[2] *= ccor_(&z__, &rc16, &hcc16, &zcc16);
L34:
    if (*mass != 48 && *mass != 49)
    {
        goto L90;
...
L35:
    ...
    /*       Density variation factor at Zlb */
    g32 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[600]);
    /*      Diffusive density at Zlb */
    gts3c_1.db32 = lower7_1.pdm[30] * exp(g32) * parm7_1.pd[600];
    /*       Diffusive density at Alt */
    d__[4] = densu_(&z__, &gts3c_1.db32, &tinf, &gts3c_1.tlb, &c_b62, &alpha[3], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    if (*mass == 49)
    {
    ...
    r__1 = 32.f - xmm;
    r__2 = alpha[3] - 1.f;
    b32 = densu_(&zh32, &gts3c_1.db32, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm32 = densu_(&z__, &b32, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm32 = zhm28;
    /*      Net density at Alt */
    d__[4] = dnet_(&d__[4], &dmix_1.dm32, &zhm32, &xmm, &c_b62);
    /*       Correction to specified mixing ratio at ground */
    gts3c_1.rl = log(b28 * lower7_1.pdm[31] / b32);
    hc32 = lower7_1.pdm[35] * parm7_1.pdl[32];
    zc32 = lower7_1.pdm[34] * parm7_1.pdl[31];
    d__[4] *= ccor_(&z__, &gts3c_1.rl, &hc32, &zc32);
L38:
    ...
    rc32 = lower7_1.pdm[33] * parm7_1.pdl[48] * (csw_1.sw[0] * parm7_1.pdl[23] * (*f107a - 150.f) + 1.f);
    /*      Net density corrected at Alt */
...
L40:
    ...
    /*       Density variation factor at Zlb */
    g40 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[750]);
    /*      Diffusive density at Zlb */
    gts3c_1.db40 = lower7_1.pdm[40] * exp(g40) * parm7_1.pd[750];
    /*       Diffusive density at Alt */
    d__[5] = densu_(&z__, &gts3c_1.db40, &tinf, &gts3c_1.tlb, &c_b67, &alpha[4], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[5];
    ...
    r__1 = 40.f - xmm;
    r__2 = alpha[4] - 1.f;
    b40 = densu_(&zh40, &gts3c_1.db40, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm40 = densu_(&z__, &b40, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm40 = zhm28;
    /*      Net density at Alt */
    d__[5] = dnet_(&d__[5], &dmix_1.dm40, &zhm40, &xmm, &c_b67);
    /*       Correction to specified mixing ratio at ground */
    gts3c_1.rl = log(b28 * lower7_1.pdm[41] / b40);
    hc40 = lower7_1.pdm[45] * parm7_1.pdl[34];
    zc40 = lower7_1.pdm[44] * parm7_1.pdl[33];
    /*      Net density corrected at Alt */
    d__[5] *= ccor_(&z__, &gts3c_1.rl, &hc40, &zc40);
L44:
    if (*mass != 48)
    {
        goto L90;
...
L45:
    ...
    /*       Density variation factor at Zlb */
    g1 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[900]);
    /*      Diffusive density at Zlb */
    gts3c_1.db01 = lower7_1.pdm[50] * exp(g1) * parm7_1.pd[900];
    /*       Diffusive density at Alt */
    d__[7] = densu_(&z__, &gts3c_1.db01, &tinf, &gts3c_1.tlb, &c_b14, &alpha[6], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[7];
    ...
    r__1 = 1.f - xmm;
    r__2 = alpha[6] - 1.f;
    b01 = densu_(&zh01, &gts3c_1.db01, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm01 = densu_(&z__, &b01, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm01 = zhm28;
    /*      Net density at Alt */
...
L48:
    ...
    /*       Density variation factor at Zlb */
    g14 = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[1050]);
    /*      Diffusive density at Zlb */
    gts3c_1.db14 = lower7_1.pdm[60] * exp(g14) * parm7_1.pd[1050];
    /*       Diffusive density at Alt */
    d__[8] = densu_(&z__, &gts3c_1.db14, &tinf, &gts3c_1.tlb, &c_b75, &alpha[7], &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                    meso7_1.tgn1);
    gts3c_1.dd = d__[8];
    ...
    r__1 = 14.f - xmm;
    r__2 = alpha[7] - 1.f;
    b14 = densu_(&zh14, &gts3c_1.db14, &tinf, &gts3c_1.tlb, &r__1, &r__2, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                 meso7_1.tgn1);
    /*      Mixed density at Alt */
    dmix_1.dm14 = densu_(&z__, &b14, &tinf, &gts3c_1.tlb, &xmm, &c_b15, &t[2],
                         &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1,
                         meso7_1.tgn1);
    zhm14 = zhm28;
    /*      Net density at Alt */
    d__[8] = dnet_(&d__[8], &dmix_1.dm14, &zhm14, &xmm, &c_b75);
    /*       Correction to specified mixing ratio at ground */
...
L46:
    ...
    g16h = csw_1.sw[20] * globe7_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1], &parm7_1.pd[1200]);
    db16h = lower7_1.pdm[70] * exp(g16h) * parm7_1.pd[1200];
    tho = lower7_1.pdm[79] * parm7_1.pdl[6];
    gts3c_1.dd = densu_(&z__, &db16h, &tho, &tho, &c_b58, &alpha[8], &t2, &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1, meso7_1.tgn1);
    ...
    d__[6] = (d__[1] * 4.f + d__[2] * 16.f + d__[3] * 28.f + d__[4] * 32.f +
             ...
             1.66e-24f;
    gts3c_1.db48 = (gts3c_1.db04 * 4.f + gts3c_1.db16 * 16.f + gts3c_1.db28 * 28.f + gts3c_1.db32 * 32.f + gts3c_1.db40 * 40.f + gts3c_1.db01 +
                    gts3c_1.db14 * 14.f) *
                   1.66e-24f;
    goto L90;
...
L50:
    z__ = dabs(*alt);
    ddum = densu_(&z__, &c_b14, &tinf, &gts3c_1.tlb, &c_b15, &c_b15, &t[2], &lower7_1.ptm[5], &gts3c_1.s, &mn1, zn1, meso7_1.tn1, meso7_1.tgn1);
L90:
...
L16:
    ...
    /* Computing 2nd power */
    r__1 = lpoly_1.dfa;
    ttest_2.t[0] = p[20] * lpoly_1.df * (p[60] * lpoly_1.dfa + 1.f) + p[21] * lpoly_1.df * lpoly_1.df + p[22] * lpoly_1.dfa + p[30] * (r__1 * r__1);
    f1 = (p[48] * lpoly_1.dfa + p[20] * lpoly_1.df + p[21] * lpoly_1.df * lpoly_1.df) * csw_1.swc[0] + 1.f;
    f2 = (p[50] * lpoly_1.dfa + p[20] * lpoly_1.df + p[21] * lpoly_1.df * lpoly_1.df) * csw_1.swc[0] + 1.f;
    /*        TIME INDEPENDENT */
    ttest_2.t[1] = p[2] * lpoly_1.plg[2] + p[3] * lpoly_1.plg[4] + p[23] * lpoly_1.plg[6] + p[15] * lpoly_1.plg[2] * lpoly_1.dfa * csw_1.swc[0] + p[27] * lpoly_1.plg[1];
    /*        SYMMETRICAL ANNUAL */
    ...
    ttest_2.t[6] = f2 * ((p[4] * lpoly_1.plg[10] + p[5] * lpoly_1.plg[12] + p[28] * lpoly_1.plg[14] + t71) * lpoly_1.ctloc + (p[7] *
                                                                                                                                  lpoly_1.plg[10] +
                                                                                                                              p[8] * lpoly_1.plg[12] + p[29] * lpoly_1.plg[14] + t72) *
                                                                                                                                 lpoly_1.stloc);
L200:
    /*        SEMIDIURNAL */
    if (csw_1.sw[7] == 0.f)
    ...
    ttest_2.t[7] = f2 * ((p[6] * lpoly_1.plg[20] + p[42] * lpoly_1.plg[22] +
                          t81) *
                             lpoly_1.c2tloc +
                         (p[9] * lpoly_1.plg[20] + p[43] * lpoly_1.plg[22] + t82) * lpoly_1.s2tloc);
L210:
    /*        TERDIURNAL */
    if (csw_1.sw[13] == 0.f)
    {
    ...
    ttest_2.t[13] = f2 * ((p[40] * lpoly_1.plg[30] + (p[94] * lpoly_1.plg[31] + p[47] * lpoly_1.plg[33]) * cd14 * csw_1.swc[4]) *
                              lpoly_1.s3tloc +
                          (p[41] * lpoly_1.plg[30] + (p[95] * lpoly_1.plg[31] + p[49] * lpoly_1.plg[33]) * cd14 * csw_1.swc[4]) *
                              lpoly_1.c3tloc);
L220:
    ...
    ttest_2.t[8] = lpoly_1.apdf * (p[33] + p[46] * lpoly_1.plg[2] + p[35] * lpoly_1.plg[4] + (p[101] * lpoly_1.plg[1] + p[102] * lpoly_1.plg[3] + p[103] * lpoly_1.plg[5]) * cd14 * csw_1.swc[4] + (p[122] * lpoly_1.plg[10] + p[123] * lpoly_1.plg[12] + p[124] * lpoly_1.plg[14]) * csw_1.swc[6] * cos(hr * (*tloc - p[125])));
    goto L40;
L30:
    if (p[52] == 0.f)
    {
    ...
    r__5 = exp1, r__6 = r__5, r__5 *= r__5, r__6 *= r__5, r__5 *= r__5, r__5 *= r__5;
    d__1 = (doublereal)exp1;
    lpoly_1.apt[0] = (ap[2] - 4.f + (p[26] - 1.f) * (ap[2] - 4.f + (exp(-dabs(p[25]) * (ap[2] - 4.f)) - 1.f) / dabs(p[25])) + ((ap[3] - 4.f + (p[26] - 1.f) * (ap[3] - 4.f + (exp(-dabs(p[25]) * (ap[3] - 4.f)) - 1.f) / dabs(p[25]))) * exp1 + (ap[4] - 4.f + (p[26] - 1.f) * (ap[4] - 4.f + (exp(-dabs(p[25]) * (ap[4] - 4.f)) - 1.f) / dabs(p[25]))) * exp1 * exp1 + (ap[5] - 4.f + (p[26] - 1.f) * (ap[5] - 4.f + (exp(-dabs(p[25]) * (ap[5] - 4.f)) - 1.f) / dabs(p[25]))) * (r__1 * (r__1 * r__1)) + ((ap[6] - 4.f + (p[26] - 1.f) * (ap[6] - 4.f + (exp(-dabs(p[25]) * (ap[6] - 4.f)) - 1.f) / dabs(p[25]))) * (r__2 * r__2) + (ap[7] - 4.f + (p[26] - 1.f) * (ap[7] - 4.f + (exp(-dabs(p[25]) * (ap[7] - 4.f)) - 1.f) / dabs(p[25]))) * (r__3 * (r__3 * r__3))) * (1.f - r__4 * r__4) / (1.f - exp1))) / (1.f + (1.f - r__6 * (r__5 * r__5)) / (1.f - exp1) * pow_dd(&d__1, &c_b96));
    /*      APT(2)=SG2(EXP1) */
    /*      APT(3)=SG0(EXP2) */
    /*      APT(4)=SG2(EXP2) */
    if (csw_1.sw[8] == 0.f)
    ...
    ttest_2.t[8] = lpoly_1.apt[0] * (p[51] + p[97] * lpoly_1.plg[2] + p[55] * lpoly_1.plg[4] + (p[126] * lpoly_1.plg[1] + p[127] * lpoly_1.plg[3] + p[128] * lpoly_1.plg[5]) * cd14 * csw_1.swc[4] + (p[129] * lpoly_1.plg[10] + p[130] * lpoly_1.plg[12] + p[131] * lpoly_1.plg[14]) * csw_1.swc[6] * cos(hr * (*tloc - p[132])));
L40:
    ...
    ttest_2.t[10] = (p[81] * lpoly_1.dfa * csw_1.swc[0] + 1.f) * ((p[65] *
                                                                       lpoly_1.plg[11] +
                                                                   p[66] * lpoly_1.plg[13] + p[67] * lpoly_1.plg[15] + p[104] * lpoly_1.plg[10] + p[105] * lpoly_1.plg[12] + p[106] * lpoly_1.plg[14] + csw_1.swc[4] * (p[110] * lpoly_1.plg[10] + p[111] * lpoly_1.plg[12] + p[112] * lpoly_1.plg[14]) * cd14) *
                                                                      cos(
                                                                          dgtr * *long__) +
                                                                  (p[91] * lpoly_1.plg[11] + p[92] * lpoly_1.plg[13] + p[93] * lpoly_1.plg[15] + p[107] * lpoly_1.plg[10] + p[108] * lpoly_1.plg[12] + p[109] * lpoly_1.plg[14] + csw_1.swc[4] * (p[113] * lpoly_1.plg[10] + p[114] * lpoly_1.plg[12] + p[115] * lpoly_1.plg[14]) * cd14) * sin(dgtr * *long__));
L230:
    ...
    ttest_2.t[11] = (p[96] * lpoly_1.plg[1] + 1.f) * (p[82] * lpoly_1.dfa * csw_1.swc[0] + 1.f) * (p[120] * lpoly_1.plg[1] * csw_1.swc[4] * cd14 + 1.f) * ((p[69] * lpoly_1.plg[1] + p[70] * lpoly_1.plg[3] + p[71] * lpoly_1.plg[5]) * cos(sr * (*sec - p[72])));
    ttest_2.t[11] += csw_1.swc[10] * (p[77] * lpoly_1.plg[21] + p[78] * lpoly_1.plg[23] + p[79] * lpoly_1.plg[25]) * cos(sr * (*sec - p[80]) + dgtr * 2.f * *long__) * (p[138] * lpoly_1.dfa * csw_1.swc[0] + 1.f);
L240:
    ...
    ttest_2.t[12] = lpoly_1.apdf * csw_1.swc[10] * (p[121] * lpoly_1.plg[1] + 1.f) * ((p[61] * lpoly_1.plg[11] + p[62] * lpoly_1.plg[13] + p[63] * lpoly_1.plg[15]) * cos(dgtr * (*long__ - p[64]))) +
                    lpoly_1.apdf * csw_1.swc[10] * csw_1.swc[4] * (p[116] * lpoly_1.plg[10] + p[117] * lpoly_1.plg[12] + p[118] * lpoly_1.plg[14]) * cd14 * cos(dgtr * (*long__ - p[119])) + lpoly_1.apdf * csw_1.swc[11] * (p[84] * lpoly_1.plg[1] + p[85] * lpoly_1.plg[3] + p[86] * lpoly_1.plg[5]) * cos(sr * (*sec - p[76]));
    goto L48;
L45:
    if (p[52] == 0.f)
    {
    ...
    ttest_2.t[12] = lpoly_1.apt[0] * csw_1.swc[10] * (p[133] * lpoly_1.plg[1] + 1.f) * ((p[53] * lpoly_1.plg[11] + p[99] * lpoly_1.plg[13] + p[68] * lpoly_1.plg[15]) * cos(dgtr * (*long__ - p[98]))) +
                    lpoly_1.apt[0] * csw_1.swc[10] * csw_1.swc[4] * (p[134] * lpoly_1.plg[10] + p[135] * lpoly_1.plg[12] + p[136] * lpoly_1.plg[14]) * cd14 * cos(dgtr * (*long__ - p[137])) + lpoly_1.apt[0] * csw_1.swc[11] * (p[56] * lpoly_1.plg[1] + p[57] * lpoly_1.plg[3] + p[58] * lpoly_1.plg[5]) * cos(sr * (*sec - p[59]));
L48:
...
L49:
    ...
    {
        /* L50: */
        ttest_2.tinf += (r__1 = csw_1.sw[i__ - 1], dabs(r__1)) * ttest_2.t[i__ - 1];
    }
...
/* Subroutine */ int tselec_0_(int n__, real *sv, real *svv)
{
    ...
    for (i__ = 1; i__ <= 25; ++i__)
    {
        ...
        if ((r__1 = sv[i__], dabs(r__1)) == 1.f || (r__2 = sv[i__], dabs(r__2)) == 2.f)
        {
            csw_1.swc[i__ - 1] = 1.f;
        }
        else
...
doublereal glob7s_(real *p)
{
    ...
    /*       TIME INDEPENDENT */
    t[1] = p[2] * lpoly_2.plg[2] + p[3] * lpoly_2.plg[4] + p[23] * lpoly_2.plg[6] + p[27] * lpoly_2.plg[1] + p[15] * lpoly_2.plg[3] + p[60] * lpoly_2.plg[5];
    /*       SYMMETRICAL ANNUAL */
    t[2] = (p[19] + p[48] * lpoly_2.plg[2] + p[30] * lpoly_2.plg[4]) * cd32;
    /*       SYMMETRICAL SEMIANNUAL */
    t[3] = (p[16] + p[17] * lpoly_2.plg[2] + p[31] * lpoly_2.plg[4]) * cd18;
    /*       ASYMMETRICAL ANNUAL */
    t[4] = (p[10] * lpoly_2.plg[1] + p[11] * lpoly_2.plg[3] + p[21] * lpoly_2.plg[5]) * cd14;
    /*       ASYMMETRICAL SEMIANNUAL */
    ...
    t[6] = (p[4] * lpoly_2.plg[10] + p[5] * lpoly_2.plg[12] + t71) *
               lpoly_2.ctloc +
           (p[7] * lpoly_2.plg[10] + p[8] * lpoly_2.plg[12] + t72) * lpoly_2.stloc;
L200:
    /*        SEMIDIURNAL */
    if (csw_1.sw[7] == 0.f)
    {
    ...
    t[7] = (p[6] * lpoly_2.plg[20] + p[42] * lpoly_2.plg[22] + t81) *
               lpoly_2.c2tloc +
           (p[9] * lpoly_2.plg[20] + p[43] * lpoly_2.plg[22] + t82) * lpoly_2.s2tloc;
L210:
    /*        TERDIURNAL */
    if (csw_1.sw[13] == 0.f)
    {
    ...
    t[13] = p[40] * lpoly_2.plg[30] * lpoly_2.s3tloc + p[41] * lpoly_2.plg[30] * lpoly_2.c3tloc;
L220:
    /*       MAGNETIC ACTIVITY */
    if (csw_1.sw[8] == 0.f)
    {
    ...
    if (csw_1.sw[8] == -1.f)
    {
        t[8] = p[51] * lpoly_2.apt[0] + p[97] * lpoly_2.plg[2] * lpoly_2.apt[0] * csw_1.swc[1];
    }
L40:
    ...
    /*        LONGITUDINAL */
    t[10] = (lpoly_2.plg[1] * (p[81] * csw_1.swc[4] * cos(dr * (lpoly_2.day - p[82])) + p[86] * csw_1.swc[5] * cos(dr * 2.f * (lpoly_2.day - p[87]))) + 1.f + p[84] * csw_1.swc[2] * cos(dr * (lpoly_2.day - p[85])) + p[88] * csw_1.swc[3] * cos(dr * 2.f * (lpoly_2.day - p[89]))) * ((p[65] * lpoly_2.plg[11] + p[66] * lpoly_2.plg[13] + p[67] * lpoly_2.plg[15] + p[75] * lpoly_2.plg[10] + p[76] * lpoly_2.plg[12] + p[77] * lpoly_2.plg[14]) * cos(dgtr * lpoly_2.long__) + (p[91] * lpoly_2.plg[11] + p[92] * lpoly_2.plg[13] + p[93] * lpoly_2.plg[15] + p[78] * lpoly_2.plg[10] + p[79] * lpoly_2.plg[12] + p[80] * lpoly_2.plg[14]) * sin(dgtr * lpoly_2.long__));
L49:
    tt = 0.f;
...
/* -------------------------------------------------------------------- */
doublereal densu_(real *alt, real *dlb, real *tinf, real *tlb, real *xm, real *alpha, real *tz, real *zlb, real *s2, integer *mn1, real *zn1, real *tn1, real *tgn1)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int spline_(real *, real *, integer *, real *,
                                        real *, real *),
        splini_(real *, real *, real *, integer *, real *, real *), splint_(real *, real *, real *, integer *, real *, real *);
    ...
    *tz = tt;
    ...
    for (k = 1; k <= i__1; ++k)
    {
        xs[k - 1] = (zn1[k] - z1) * (parmb_1.re + z1) / (parmb_1.re + zn1[k]) / zgdif;
        ys[k - 1] = 1.f / tn1[k];
        /* L20: */
    }
...
/* -------------------------------------------------------------------- */
doublereal densm_(real *alt, real *d0, real *xm, real *tz, integer *mn3, real *zn3, real *tn3, real *tgn3, integer *mn2, real *zn2, real *tn2, real *tgn2)
{
    /* Initialized data */
    ...
    for (k = 1; k <= i__1; ++k)
    {
        xs[k - 1] = (zn2[k] - z1) * (parmb_1.re + z1) / (parmb_1.re + zn2[k]) / zgdif;
        ys[k - 1] = 1.f / tn2[k];
        /* L210: */
    }
...
L20:
    ...
    for (k = 1; k <= i__1; ++k)
    {
        xs[k - 1] = (zn3[k] - z1) * (parmb_1.re + z1) / (parmb_1.re + zn3[k]) / zgdif;
        ys[k - 1] = 1.f / tn3[k];
        /* L220: */
    }
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ int spline_(real *x, real *y, integer *n, real *yp1, real *ypn, real *y2)
{
    /* System generated locals */
    integer i__1;
    ...
    for (i__ = 2; i__ <= i__1; ++i__)
    {
        ...
        p = sig * y2[i__ - 1] + 2.f;
        y2[i__] = (sig - 1.f) / p;
        u[i__ - 1] = (((y[i__ + 1] - y[i__]) / (x[i__ + 1] - x[i__]) - (y[i__] - y[i__ - 1]) / (x[i__] - x[i__ - 1])) * 6.f / (x[i__ + 1] - x[i__ - 1]) - sig * u[i__ - 2]) / p;
        /* L11: */
    }
    if (*ypn > 9.9e29f)
    {
    ...
    {
        qn = .5f;
        un = 3.f / (x[*n] - x[*n - 1]) * (*ypn - (y[*n] - y[*n - 1]) / (x[*n] - x[*n - 1]));
    }
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ int splint_(real *xa, real *ya, real *y2a, integer *n, real *x, real *y)
{
    /* Builtin functions */
...
L1:
    ...
    a = (xa[khi] - *x) / h__;
    b = (*x - xa[klo]) / h__;
    *y = a * ya[klo] + b * ya[khi] + ((a * a * a - a) * y2a[klo] + (b * b * b - b) * y2a[khi]) * h__ * h__ / 6.f;
    return 0;
} /* splint_ */

/* ----------------------------------------------------------------------- */
/* Subroutine */ int splini_(real *xa, real *ya, real *y2a, integer *n, real *x, real *yi)
{
    /* System generated locals */
    real r__1, r__2;
...
L1:
    if (*x > xa[klo] && khi <= *n)
    {
        ...
        a2 = a * a;
        b2 = b * b;
        *yi += ((1.f - a2) * ya[klo] / 2.f + b2 * ya[khi] / 2.f + ((-(a2 * a2 + 1.f) / 4.f + a2 / 2.f) * y2a[klo] + (b2 * b2 / 4.f - b2 / 2.f) * y2a[khi]) * h__ * h__ / 6.f) * h__;
        ++klo;
        ++khi;
        goto L1;
    }
...
/*          MSISE-00 01-FEB-02 */
/*     DATA ISDATE/'01-F','EB-0','2   '/,ISTIME/'15:4','9:27'/ ! cout, SCS, 2017 */
/*     DATA NAME/'MSIS','E-00'/                                ! cout, SCS, 2017 */
/*         TEMPERATURE */
/*         HE DENSITY */
/*         O DENSITY */
/*         N2 DENSITY */
